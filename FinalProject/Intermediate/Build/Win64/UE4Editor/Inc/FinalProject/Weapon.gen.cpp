...
// Cross Module References
	FINALPROJECT_API UScriptStruct* Z_Construct_UScriptStruct_FWeaponDataTable();
	...
	FINALPROJECT_API UClass* Z_Construct_UClass_AWeapon();
...
class UScriptStruct* FWeaponDataTable::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern FINALPROJECT_API uint32 Get_Z_Construct_UScriptStruct_FWeaponDataTable_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FWeaponDataTable, Z_Construct_UPackage__Script_FinalProject(), TEXT("WeaponDataTable"), sizeof(FWeaponDataTable), Get_Z_Construct_UScriptStruct_FWeaponDataTable_Hash());
	}
	return Singleton;
}
template<> FINALPROJECT_API UScriptStruct* StaticStruct<FWeaponDataTable>()
{
	return FWeaponDataTable::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FWeaponDataTable(FWeaponDataTable::StaticStruct, TEXT("/Script/FinalProject"), TEXT("WeaponDataTable"), false, nullptr, nullptr);
static struct FScriptStruct_FinalProject_StaticRegisterNativesFWeaponDataTable
{
	FScriptStruct_FinalProject_StaticRegisterNativesFWeaponDataTable()
	{
		UScriptStruct::DeferCppStructOps<FWeaponDataTable>(FName(TEXT("WeaponDataTable")));
	}
} ScriptStruct_FinalProject_StaticRegisterNativesFWeaponDataTable;
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FWeaponDataTable_Statics::NewProp_AmmoType = { "AmmoType", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FWeaponDataTable, AmmoType), Z_Construct_UEnum_FinalProject_EAmmoType, METADATA_PARAMS(Z_Construct_UScriptStruct_FWeaponDataTable_Statics::NewProp_AmmoType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWeaponDataTable_Statics::NewProp_AmmoType_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FWeaponDataTable_Hash() { return 586141631U; }
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AWeapon_Statics::NewProp_WeaponType = { "WeaponType", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AWeapon, WeaponType), Z_Construct_UEnum_FinalProject_EWeaponType, METADATA_PARAMS(Z_Construct_UClass_AWeapon_Statics::NewProp_WeaponType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AWeapon_Statics::NewProp_WeaponType_MetaData)) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWeapon_Statics::NewProp_AmmoType_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "WeaponProperties" },
		{ "Comment", "/** Type of the ammo for this weapon*/" },
		{ "ModuleRelativePath", "Weapon.h" },
		{ "ToolTip", "Type of the ammo for this weapon" },
	};
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AWeapon_Statics::NewProp_AmmoType = { "AmmoType", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AWeapon, AmmoType), Z_Construct_UEnum_FinalProject_EAmmoType, METADATA_PARAMS(Z_Construct_UClass_AWeapon_Statics::NewProp_AmmoType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AWeapon_Statics::NewProp_AmmoType_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWeapon_Statics::NewProp_WeaponDataTable_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "DataTable" },
		{ "Comment", "/** Data table for weapon properties */" },
		{ "ModuleRelativePath", "Weapon.h" },
		{ "ToolTip", "Data table for weapon properties" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWeapon_Statics::NewProp_CrosshairsMiddle_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "DataTable" },
		{ "Comment", "/** Textures for the weapon crosshair*/" },
		{ "ModuleRelativePath", "Weapon.h" },
		{ "ToolTip", "Textures for the weapon crosshair" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWeapon_Statics::NewProp_MuzzleFlash_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "DataTable" },
		{ "Comment", "/** Particle system spawn at barrel socket*/" },
		{ "ModuleRelativePath", "Weapon.h" },
		{ "ToolTip", "Particle system spawn at barrel socket" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWeapon_Statics::NewProp_FireSound_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "DataTable" },
		{ "Comment", "/** Sound played when the weapon is fired*/" },
		{ "ModuleRelativePath", "Weapon.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWeapon_Statics::NewProp_SlideDisplacement_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Pistol" },
		{ "Comment", "/** Amount that the slide is push back during pistol fire*/" },
		{ "ModuleRelativePath", "Weapon.h" },
		{ "ToolTip", "Amount that the slide is push back during pistol fire" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWeapon_Statics::NewProp_SlideDisplacementCurve_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Pistol" },
		{ "Comment", "/** Curve for the slide displacement*/" },
		{ "ModuleRelativePath", "Weapon.h" },
		{ "ToolTip", "Curve for the slide displacement" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWeapon_Statics::NewProp_bMovingSlide_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Pistol" },
		{ "Comment", "/** True when moving pistol slide*/" },
		{ "ModuleRelativePath", "Weapon.h" },
		{ "ToolTip", "True when moving pistol slide" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWeapon_Statics::NewProp_MaxSlideDisplacement_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Pistol" },
		{ "Comment", "/** Max distance for the slide on the pistal*/" },
		{ "ModuleRelativePath", "Weapon.h" },
		{ "ToolTip", "Max distance for the slide on the pistal" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWeapon_Statics::NewProp_MaxRecoilRotation_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Pistol" },
		{ "Comment", "/** Max rotation forpistol recoil*/" },
		{ "ModuleRelativePath", "Weapon.h" },
		{ "ToolTip", "Max rotation forpistol recoil" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWeapon_Statics::NewProp_bAutomatic_MetaData[] = {
		...
		{ "Comment", "/** True for auto gunfire*/" },
		{ "ModuleRelativePath", "Weapon.h" },
		{ "ToolTip", "True for auto gunfire" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWeapon_Statics::NewProp_Damage_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Weapon Properties" },
		{ "Comment", "/** Amount of damage cause by a bullet*/" },
		{ "ModuleRelativePath", "Weapon.h" },
		{ "ToolTip", "Amount of damage cause by a bullet" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWeapon_Statics::NewProp_HeadShotDamage_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Weapon Properties" },
		{ "Comment", "/** Amount of damage when a bullet hit a head*/" },
		{ "ModuleRelativePath", "Weapon.h" },
		{ "ToolTip", "Amount of damage when a bullet hit a head" },
	};
#endif
	...
	IMPLEMENT_CLASS(AWeapon, 1314881136);
	template<> FINALPROJECT_API UClass* StaticClass<AWeapon>()
	{
		return AWeapon::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AWeapon(Z_Construct_UClass_AWeapon, &AWeapon::StaticClass, TEXT("/Script/FinalProject"), TEXT("AWeapon"), false, nullptr, nullptr, nullptr);
