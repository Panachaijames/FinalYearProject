...
// Cross Module References
	FINALPROJECT_API UClass* Z_Construct_UClass_AAmmo_NoRegister();
	FINALPROJECT_API UClass* Z_Construct_UClass_AAmmo();
...
// End Cross Module References
	DEFINE_FUNCTION(AAmmo::execAmmoSphereOverlap)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->AmmoSphereOverlap(Z_Param_OverlappedComponent,Z_Param_OtherActor,Z_Param_OtherComp,Z_Param_OtherBodyIndex,Z_Param_bFormSweep,Z_Param_Out_SweepResult);
		P_NATIVE_END;
	}
	...
	void Z_Construct_UFunction_AAmmo_AmmoSphereOverlap_Statics::NewProp_bFormSweep_SetBit(void* Obj)
	{
		((Ammo_eventAmmoSphereOverlap_Parms*)Obj)->bFormSweep = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AAmmo_AmmoSphereOverlap_Statics::NewProp_bFormSweep = { "bFormSweep", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Ammo_eventAmmoSphereOverlap_Parms), &Z_Construct_UFunction_AAmmo_AmmoSphereOverlap_Statics::NewProp_bFormSweep_SetBit, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AAmmo_AmmoSphereOverlap_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AAmmo_AmmoSphereOverlap_Statics::NewProp_bFormSweep,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AAmmo_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AAmmo_AmmoSphereOverlap, "AmmoSphereOverlap" }, // 1968444825
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AAmmo_Statics::NewProp_AmmoType = { "AmmoType", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AAmmo, AmmoType), Z_Construct_UEnum_FinalProject_EAmmoType, METADATA_PARAMS(Z_Construct_UClass_AAmmo_Statics::NewProp_AmmoType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AAmmo_Statics::NewProp_AmmoType_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAmmo_Statics::NewProp_AmmoCollisionSphere_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Ammo" },
		{ "Comment", "/** Overlap Sphere for picking up ammo*/" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Ammo.h" },
		{ "ToolTip", "Overlap Sphere for picking up ammo" },
	};
#endif
	...
	IMPLEMENT_CLASS(AAmmo, 1818826407);
	template<> FINALPROJECT_API UClass* StaticClass<AAmmo>()
	{
		return AAmmo::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AAmmo(Z_Construct_UClass_AAmmo, &AAmmo::StaticClass, TEXT("/Script/FinalProject"), TEXT("AAmmo"), false, nullptr, nullptr, nullptr);
