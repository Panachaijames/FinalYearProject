...
#include "FinalProject/Explosive.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	FINALPROJECT_API UClass* Z_Construct_UClass_AExplosive_NoRegister();
	FINALPROJECT_API UClass* Z_Construct_UClass_AExplosive();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AExplosive_Statics::NewProp_ExplodeParticles_MetaData[] = {
		...
		{ "Category", "Combat" },
		{ "Comment", "/** Explosion when hit by a bullet */" },
		{ "ModuleRelativePath", "Explosive.h" },
		{ "ToolTip", "Explosion when hit by a bullet" },
	};
#endif
	...
	IMPLEMENT_CLASS(AExplosive, 759504357);
	template<> FINALPROJECT_API UClass* StaticClass<AExplosive>()
	{
		return AExplosive::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AExplosive(Z_Construct_UClass_AExplosive, &AExplosive::StaticClass, TEXT("/Script/FinalProject"), TEXT("AExplosive"), false, nullptr, nullptr, nullptr);
