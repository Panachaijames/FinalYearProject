...
#include "FinalProject/EnemyController.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	FINALPROJECT_API UClass* Z_Construct_UClass_AEnemyController_NoRegister();
	FINALPROJECT_API UClass* Z_Construct_UClass_AEnemyController();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemyController_Statics::NewProp_BehaviorTreeComponent_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "AI Behavior" },
		{ "Comment", "/** Behaviour tree component for this enemy*/" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "EnemyController.h" },
		{ "ToolTip", "Behaviour tree component for this enemy" },
	};
#endif
	...
	IMPLEMENT_CLASS(AEnemyController, 4107976045);
	template<> FINALPROJECT_API UClass* StaticClass<AEnemyController>()
	{
		return AEnemyController::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AEnemyController(Z_Construct_UClass_AEnemyController, &AEnemyController::StaticClass, TEXT("/Script/FinalProject"), TEXT("AEnemyController"), false, nullptr, nullptr, nullptr);
