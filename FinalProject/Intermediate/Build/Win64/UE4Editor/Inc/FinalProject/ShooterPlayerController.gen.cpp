...
#include "FinalProject/ShooterPlayerController.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	FINALPROJECT_API UClass* Z_Construct_UClass_AShooterPlayerController_NoRegister();
	FINALPROJECT_API UClass* Z_Construct_UClass_AShooterPlayerController();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AShooterPlayerController_Statics::NewProp_HUDOverlay_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Widgets" },
		{ "Comment", "/** Variable to holds the HUD Overlay Widget after Creating it */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "ShooterPlayerController.h" },
		{ "ToolTip", "Variable to holds the HUD Overlay Widget after Creating it" },
	};
#endif
	...
	IMPLEMENT_CLASS(AShooterPlayerController, 3672967393);
	template<> FINALPROJECT_API UClass* StaticClass<AShooterPlayerController>()
	{
		return AShooterPlayerController::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AShooterPlayerController(Z_Construct_UClass_AShooterPlayerController, &AShooterPlayerController::StaticClass, TEXT("/Script/FinalProject"), TEXT("AShooterPlayerController"), false, nullptr, nullptr, nullptr);
