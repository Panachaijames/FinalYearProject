 ...
 */
UCLASS()
class FINALPROJECT_API AWeapon : public AItem
{
	GENERATED_BODY()
public:
	AWeapon();
...
private:
	...
	/** Type of the ammo for this weapon*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = WeaponProperties, meta = (AllowPrivateAccess = "true"))
	EAmmoType AmmoType;
	...
	/** Particle system spawn at barrel socket*/
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = DataTable, meta = (AllowPrivateAccess = "true"))
	class UParticleSystem* MuzzleFlash;
	...
	/** Amount of damage when a bullet hit a head*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Weapon Properties", meta = (AllowPrivateAccess = "true"))
	float HeadShotDamage;
