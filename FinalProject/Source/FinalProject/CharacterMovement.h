...
struct FInterpLocation
{
	...
	//Number of item interping to/at this scene comp location
	UPROPERTY(VisibleAnywhere, BlueprintReadonly)
	int32 ItemCount;
};
...
protected:
	...
	*/
	...
	/** Called from Animation Blueprint with Realease Clip notify*/
	UFUNCTION(BlueprintCallable)
	void ReleaseClip();
...
private:
	...
	/** Sound made by character get hit by melee atk*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
	...
	/**Hit React Anim Monatge when character is stunnned*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
